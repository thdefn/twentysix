...
import static cm.twentysix.brand.exception.Error.REQUEST_ARGUMENT_NOT_VALID;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse<String>> handleBrandException(BrandException e) {
