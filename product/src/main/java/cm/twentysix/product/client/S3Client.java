...
import cm.twentysix.product.exception.FileException;
import cm.twentysix.product.util.FilePathUtil;
...
import static cm.twentysix.product.exception.Error.FILE_UPLOAD_FAILED;
